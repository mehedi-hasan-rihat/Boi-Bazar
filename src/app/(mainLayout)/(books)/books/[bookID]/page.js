...
export default async function page({ params }) {
  ...
  return (
    <div className="container mx-auto min-h-[calc(100vh-250px)] my-10 flex  items-center justify-center">
      ...
      <div className="text-gray-700 text-sm flex-1 max-w-3xl">
        ...
        <p className="text-lg mt-1 font-semibold ">TK. {150} <span className="text-sm">Only</span></p>
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-2 gap-x-1 gap-y-1 w-max">
            ...
            <p className="font-medium">Hoauk Publuication</p>
